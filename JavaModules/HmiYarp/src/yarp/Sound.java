...
public class Sound extends Portable {
  ...
  protected Sound(long cPtr, boolean cMemoryOwn) {
    super(yarpJNI.Sound_SWIGUpcast(cPtr), cMemoryOwn);
    swigCPtr = cPtr;
  }
  ...
  public Sound subSound(int first_sample, int last_sample) {
    return new Sound(yarpJNI.Sound_subSound(swigCPtr, this, first_sample, last_sample), true);
  }
  ...
  public void clear() {
    yarpJNI.Sound_clear(swigCPtr, this);
  }
  ...
  public boolean read(ConnectionReader connection) {
    return yarpJNI.Sound_read(swigCPtr, this, ConnectionReader.getCPtr(connection), connection);
  }
