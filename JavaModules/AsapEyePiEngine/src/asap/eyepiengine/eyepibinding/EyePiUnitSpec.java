...
/**
 * XML parser for the EyePiUnitSpec in a eyepibinding
 * @author Dennis
 */
public class EyePiUnitSpec extends XMLStructureAdapter
{
    public EyePiUnit eyepiUnit;
    private String type;
    ...
    public void decodeContent(XMLTokenizer tokenizer) throws IOException
    {
        while (tokenizer.atSTag())
        {
            ...
            else if (tag.equals(EyePiUnitAssembler.xmlTag()))
            {
                EyePiUnitAssembler wua = new EyePiUnitAssembler();
                wua.readXML(tokenizer);
                eyepiUnit = wua.getEyePiUnit();
            }
            else
            	throw new RuntimeException("EyePiUnitSpec contains unknown element "+tag);	
        }
    }
     ...
     */
    private static final String XMLTAG = "EyePiUnitSpec";
