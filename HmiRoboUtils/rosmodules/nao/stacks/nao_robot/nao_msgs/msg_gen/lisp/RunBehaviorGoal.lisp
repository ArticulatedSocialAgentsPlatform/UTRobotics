...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<RunBehaviorGoal>)))
  ...
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%# Goal [behavior]: name of the behavior to be executed~%# Result [noErrors]: true if behavior finished executing correctly, false otherwise~%# Feedback: none as NaoQI API cannot be queried in this respect~%string behavior~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'RunBehaviorGoal)))
  "Returns full string definition for message of type 'RunBehaviorGoal"
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%# Goal [behavior]: name of the behavior to be executed~%# Result [noErrors]: true if behavior finished executing correctly, false otherwise~%# Feedback: none as NaoQI API cannot be queried in this respect~%string behavior~%~%~%"))
