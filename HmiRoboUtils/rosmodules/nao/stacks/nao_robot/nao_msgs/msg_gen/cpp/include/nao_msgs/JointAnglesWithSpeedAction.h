/* Auto-generated by genmsg_cpp for file /home/rob/ros_workspace/rosmodules/nao/stacks/nao_robot/nao_msgs/msg/JointAnglesWithSpeedAction.msg */
...
struct JointAnglesWithSpeedAction_ {
  ...
  typedef  ::nao_msgs::JointAnglesWithSpeedActionGoal_<ContainerAllocator>  _action_goal_type;
   ::nao_msgs::JointAnglesWithSpeedActionGoal_<ContainerAllocator>  action_goal;

  typedef  ::nao_msgs::JointAnglesWithSpeedActionResult_<ContainerAllocator>  _action_result_type;
   ::nao_msgs::JointAnglesWithSpeedActionResult_<ContainerAllocator>  action_result;

  typedef  ::nao_msgs::JointAnglesWithSpeedActionFeedback_<ContainerAllocator>  _action_feedback_type;
   ::nao_msgs::JointAnglesWithSpeedActionFeedback_<ContainerAllocator>  action_feedback;
...
}; // struct JointAnglesWithSpeedAction
...
{
template<class ContainerAllocator> struct IsMessage< ::nao_msgs::JointAnglesWithSpeedAction_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::nao_msgs::JointAnglesWithSpeedAction_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
